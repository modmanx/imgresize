...
// echo file_get_contents('https://www.judobase.org/files/persons//2011/09//13451_13450_60_04_.jpg');
// exit;
...
if(isset($_GET['test_ts'])){
        echo (int)isset($resolve_cache[$qs_hash]);
        echo '<br>';
...
if(isset($resolve_cache[$qs_hash])){
        do_redirect($resolve_cache[$qs_hash]);
        exit;
}
